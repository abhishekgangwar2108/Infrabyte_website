        ...
        <Row className="justify-content-center">
          <Col xl={8} lg={9} md={11}>
            ...
            <Row className="gy-4 align-items-center mb-lg-5 mb-4 pb-3">
              ...
              <Col md={9}>
                <Row xs={2} sm={3} className="gy-2">
                  {[
                    { id: 's-daily-newsletter', label: 'Daily Newsletter' },
                    { id: 's-advertising-updates', label: 'Advertising Updates', checked: true },
                    { id: 's-week-in-review', label: 'Week in Review' },
                    { id: 's-event-updates', label: 'Event Updates' },
                    { id: 's-startups-weekly', label: 'Startups Weekly' },
                    { id: 's-podcasts', label: 'Podcasts' },
                  ].map(item => (
                    <Col key={item.id}>
                      <FormCheck
                        type="checkbox"
            ...
            <Form className="d-flex flex-sm-row flex-column mb-3 needs-validation" noValidate>
              <InputGroup className="me-sm-3 mb-sm-0 mb-3 position-relative">
                <FormControl
                  type="email"
