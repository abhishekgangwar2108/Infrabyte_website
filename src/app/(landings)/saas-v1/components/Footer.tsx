          ...
          <Col xl={6} lg={7} md={5} className="offset-xl-2 offset-md-1 pt-4 pt-md-1 pt-lg-0">
            <Row id="footer-links">
              <Col lg={4}>
                <h6 className="mb-2">
                  <a
                    className="d-block text-dark dropdown-toggle d-lg-none py-2 border-0 bg-transparent"
                  ...
                  <span className="d-none d-lg-block">Useful Links</span>
                </h6>
                <Collapse in={openLinks} className="d-lg-block">
                  <div>
                    <ul className="nav flex-column pb-lg-1 mb-lg-3">
                      {footerData.links.map((link, i) => (
                        <li key={i} className="nav-item">
                          <Link to={link.url} className="nav-link d-inline-block px-0 pt-1 pb-2">
                            {link.title}
                          </Link>
                        </li>
                      ))}
              ...
              <Col xl={4} lg={3}>
                ...
                <Collapse in={openSocials} className="d-lg-block">
                  <div>
                    <ul className="nav flex-column mb-2 mb-lg-0">
              ...
              <Col xl={4} lg={5} className="pt-2 pt-lg-0">
                ...
                <Link to={`mailto:${footerData.email}`} className="fw-medium">
                  {footerData.email}
                </Link>
              </Col>
            </Row>
