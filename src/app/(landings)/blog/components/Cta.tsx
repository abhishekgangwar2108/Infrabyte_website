          ...
          <Col xl={8} lg={9} md={11}>
            <h2 className="h1 d-md-inline-block position-relative mb-md-5 mb-sm-4 text-sm-start text-center">
              ...
              <svg
                ...
                style={{ left: '100%', width: '65', height: '68', fill: '#6366f1' }}
              >
            ...
            <Row className="gy-4 align-items-center mb-lg-5 mb-4 pb-3">
              <Col md={3}>
                <h3 className="h5 mb-0 text-sm-start text-center">Sign up for Newsletters</h3>
              </Col>
              <Col md={9}>
                <Row className="row-cols-sm-3 row-cols-2 gy-2">
                  <Col>
                    <div className="form-check mb-0">
                      <input type="checkbox" id="s-daily-newsletter" className="form-check-input" />
                      <label htmlFor="s-daily-newsletter" className="form-check-label">
                        Daily Newsletter
                      </label>
                    </div>
                  </Col>
                  <Col>
                    <div className="form-check mb-0">
                      <input
                        type="checkbox"
                        id="s-advertising-updates"
                        className="form-check-input"
                        checked
                      />
                      <label htmlFor="s-advertising-updates" className="form-check-label">
                        Advertising Updates
                      </label>
                    </div>
                  </Col>
                  <Col>
                    <div className="form-check mb-0">
                      ...
                      <label htmlFor="s-week-in-review" className="form-check-label">
                        Week in Review
                      </label>
                    </div>
                  </Col>
                  <Col>
                    <div className="form-check mb-0">
                      ...
                      <label htmlFor="s-event-updates" className="form-check-label">
                        Event Updates
                      </label>
                    </div>
                  </Col>
                  <Col>
                    <div className="form-check mb-0">
                      ...
                      <label htmlFor="s-startups-weekly" className="form-check-label">
                        Startups Weekly
                      </label>
                    </div>
                  </Col>
                  <Col>
                    <div className="form-check mb-0">
                      ...
                      <label htmlFor="s-podcasts" className="form-check-label">
                        Podcasts
                      </label>
                    </div>
                  </Col>
            ...
            <form className="d-flex flex-sm-row flex-column mb-3 needs-validation" noValidate>
              <div className="input-group me-sm-3 mb-sm-0 mb-3">
                ...
                <IconifyIcon
                  icon="bx:envelope"
                  className="position-absolute start-0 top-50 translate-middle-y ms-3 zindex-5 fs-5 text-muted"
                />
                <div className="invalid-tooltip position-absolute start-0 top-0 mt-n4">
            ...
            <div className="form-text fs-sm text-sm-start text-center">
              * Yes, I agree to the <Link to="#">terms</Link> and{' '}
