  ...
  return (
    <section className="container py-5">
      <Row className="mt-lg-3 pt-1 pt-md-4 pt-lg-5">
        ...
        <Col xl={9} md={8}>
          <img src={venue} className="rounded-3" width="952" alt="Venue" />
        </Col>
      </Row>
      <Row className="mb-lg-3 pb-1 pb-md-4 pb-lg-5 mt-4 mt-sm-n5">
        <Col lg={4} md={5} className="offset-md-6 offset-lg-7 mt-md-n5">
          <div className="gallery mt-md-n4 mx-auto" style={{ maxWidth: '416px' }}>
            <Link
              to="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.192027341148!2d-74.0045150840621!3d40.75780104274828!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c2f66383c1d305%3A0xb1589156bdadde83!2sJavits%20Center!5e0!3m2!1sen!2sua!4v1638895524631!5m2!1sen!2sua"
              data-iframe="true"
              className="gallery-item rounded-2"
              data-sub-html='<h6 class="fs-sm text-light">Javits Center, NY, USA</h6>'
            >
              <img src={mapLight} className="d-dark-mode-none" alt="Map preview" />
              <img src={mapDark} className="d-none d-dark-mode-block" alt="Map preview" />
