import cover from '@/assets/img/landing/digital-agency/cover.jpg';

const Atmosphere = () => {
  return (
    <section className="container mb-5 pb-lg-5 pt-2 pt-md-4">
      <h2 className="h1 d-md-inline-block position-relative mb-md-5 mb-4 text-md-start text-center">
      ...
      <img src={cover} alt="Team cover" className="rounded-3" />
    </section>
  );
};
