          ...
          >
            <div className="mb-md-5 pb-xl-5 mb-4">
              <div className="d-inline-flex align-items-center position-relative mb-3">
                {/* <GlightBox
                  href="https://www.youtube.com/watch?v=xx2sK-QiBjw"
                ...
                <IconifyIcon icon="ix:electrical-energy" fontSize={40} />
                <h4 className="mb-0">Im(AI)gine Performance Future</h4>
              </div>

              <h1 className="display-4 mb-md-5 mb-3 pb-3">
                Designing What's Next <br />
                in Digital <br />
                 Performance
              </h1>
              <div className="d-md-flex align-items-md-start">
                ...
                <p className="d-lg-block d-none mb-0 ps-md-3">
                  "At Infrabyte Technology, we design intelligent Salesforce ecosystems where Agentic AI, data, 
                  and human design converge - systems that think with data, learn from experience, and perform with purpose."
